...
import { Container, Card, AppBar, Typography, Grow, Grid } from '@material-ui/core';
...
function Contactus() {
  ...
  const classes = useStyles();
    return (
      <div >
            <Grid container style={{marginTop:"20px", marginBottom:"20px"}} justifyContent="space-between" alignItems="center" >
             ...
             <Card>
             <div style={{marginLeft:"20px", height:"250px"}}>
            ...
            <div style={{marginTop:"10px", marginLeft:"20px",marginBottom:"30px",  marginRight:"20px"}}>
    ...
    <Col><span  STYLE="color:black;font-weight:600;font-size:20px"><PhoneAndroidIcon/>My Telstra App</span></Col>
    <Col><span  STYLE="color:black;font-weight:600;font-size:20px"><StoreIcon/>In Store</span></Col>
    <Col><span  STYLE="color:black;font-weight:600;font-size:20px"><LanguageIcon/>Multilingual Support</span></Col>
  </Row>
  <Row md={12}  sm={12} xs={12} style={{marginTop:"20px"}} spacing={3}>
    <Col> <p>Manage your services on the go and send a message if you need.</p></Col>
    <Col><p> Find your nearest Telstra store or Wi-Fi hotspot</p></Col>
    <Col><p> Speak to us in your preferred language. We've got you covered.</p></Col>
  </Row>
  </Container>
       ...
       <div className="icons">
         <Container>
       <Row md={4}>
    <Col> <FacebookLoginButton onClick={handleClick_1} style={{width:"50px"}}>  <span></span></FacebookLoginButton></Col>
    <Col><TwitterLoginButton onClick={handleClick_2}  style={{width:"50px"}}><span></span></TwitterLoginButton></Col>
    <Col> <InstagramLoginButton onClick={handleClick_3}  style={{width:"50px"}}><span></span></InstagramLoginButton></Col>
    <Col><LinkedInLoginButton onClick={handleClick_4}  style={{width:"50px"}}><span></span></LinkedInLoginButton></Col>
  </Row>
  </Container>
      </div>
   </div>
