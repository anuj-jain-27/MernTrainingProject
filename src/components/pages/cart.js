...
import Card from '../productcard/cartproduct'
import { getCart } from '../../actions/cart';
import {Button, Grid, CircularProgress,Paper, Typography } from '@material-ui/core';
import { makeStyles } from '@material-ui/core/styles';
import Googlemodal from '../googleauth/googlemodal'
import Orderslider from '../productcard/orderslider'
  ...
  var prodjsx = cart.map(prod => {
    ...
    //  <Paper style={{marginTop: "10px",height:"50px" }}>
     ...
     // </Paper>
      ...
      <Orderslider openPayment={openPayment}/>
      </Paper>
      </div>
    );
  }
