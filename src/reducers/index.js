...
export default combineReducers({
    ...
    products,orders,auth,searchResultsProduct,cart,posts,datas,plans,broadbands, blocations, paydetails, cards, searchResults, currentbroadband, broadbandhistory, planuser,
});